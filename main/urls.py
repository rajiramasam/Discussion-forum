...
from .views import delete_post, home, detail, posts, create_post, latest_posts , search_result ,update_post , delete_post , error404 , profile_error, login_view,signup_view
